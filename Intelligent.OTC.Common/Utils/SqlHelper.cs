...
namespace Intelligent.OTC.Common.Utils
{
    public static class SqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public static readonly string ConnectionString = string.Format(ConfigurationManager.ConnectionStrings["OTCDB"].ToString(), AESUtil.AESDecrypt(ConfigurationManager.AppSettings["OTC_Password"].ToString()));
