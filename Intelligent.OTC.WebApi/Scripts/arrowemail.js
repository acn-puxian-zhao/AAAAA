        ...
        function ($scope, collectorSoaProxy, baseDataProxy, permissionProxy, siteProxy, invoiceProxy, modalService,
            ...
            $scope.executeList = {
                ...
                columnDefs: [
                    ...
                    { field: 'customerNum', displayName: 'Customer Code', width: '70' },
                    ...
                    { field: 'totalAmt', displayName: 'Total A/R Balance', width: '80', cellFilter: 'number:2', type: 'number' },
                    { field: 'pastDueAmt', displayName: 'Past Due Amount', width: '80', cellFilter: 'number:2', type: 'number' },
                    { field: 'fDueOver90Amt', displayName: 'Operator', width: '80', cellFilter: 'number:2', type: 'number' },
                    { field: 'fDueOver90Amt', displayName: 'FSR', width: '80', cellFilter: 'number:2', type: 'number' },
                    { field: 'fDueOver90Amt', displayName: 'Credit Limit', width: '80', cellFilter: 'number:2', type: 'number' },
                    { field: 'fDueOver90Amt', displayName: 'Payment Term Desc', width: '80', cellFilter: 'number:2', type: 'number' },
            ...
            $scope.batchList = {
                ...
                columnDefs: [
                    ...
                    //{ field: 'contact', displayName: 'Contact', width: '160' },
                    { field: 'class', displayName: 'Customer Class', width: '70' },
                    { field: 'risk', displayName: 'Risk Score', width: '70', type: 'number' },
                    {
                        field: 'totalAmt', displayName: 'Total A/R Balance', width: '80', cellFilter: 'number:2', type: 'number', footerCellFilter: 'currency'
                        , aggregationType: uiGridConstants.aggregationTypes.sum
                    },
                    {
                        field: 'pastDueAmount', displayName: 'Past Due Amount', width: '80', cellFilter: 'number:2', type: 'number', footerCellFilter: 'currency'
                        , aggregationType: uiGridConstants.aggregationTypes.sum
                    },
                    {
                        field: 'fDueOver90Amt', displayName: 'Over 90 days', width: '80', cellFilter: 'number:2', type: 'number', footerCellFilter: 'currency'
                        , aggregationType: uiGridConstants.aggregationTypes.sum
                    },
                    {
                        field: 'creditLimit', displayName: 'Credit Limit', width: '80', cellFilter: 'number:2', type: 'number', footerCellFilter: 'currency'
                        , aggregationType: uiGridConstants.aggregationTypes.sum
                    },
                    { field: 'isHoldFlg', displayName: 'Account Status', width: '80' },
                    { field: 'operator', displayName: 'Collector', width: '90' },
            ...
            buildFilter = function () {
                ...
                //bill Grop Code
                if ($scope.SiteUserId) {
                    filterStr += " and (contains(SiteUserId,'" + encodeURIComponent($scope.SiteUserId) + "'))";
                }
