...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["angular-file-upload_com"] = factory();
	else
		root["angular-file-upload_com"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var serviceFileUploaderCommon = _interopRequire(__webpack_require__(3));
	...
	angular.module(CONFIG.name, []).value("fileUploaderOptionsCommon", options).factory("FileUploaderCommon", serviceFileUploaderCommon).factory("FileLikeObjectCommon", serviceFileLikeObject).factory("FileItemCommon", serviceFileItem).factory("FileDirectiveCommon", serviceFileDirective).factory("FileSelectCommon", serviceFileSelect).factory("FileDropCommon", serviceFileDrop).factory("FileOverCommon", serviceFileOver).directive("nvFileSelectCommon", directiveFileSelect).directive("nvFileDropCommon", directiveFileDrop).directive("nvFileOverCommon", directiveFileOver).run(["FileUploaderCommon", "FileLikeObjectCommon", "FileItemCommon", "FileDirectiveCommon", "FileSelectCommon", "FileDropCommon", "FileOverCommon", function (FileUploaderCommon, FileLikeObject, FileItem, FileDirective, FileSelect, FileDrop, FileOver) {
	    // only for compatibility
	    FileUploaderCommon.FileLikeObject = FileLikeObject;
	    FileUploaderCommon.FileItem = FileItem;
	    FileUploaderCommon.FileDirective = FileDirective;
	    FileUploaderCommon.FileSelect = FileSelect;
	    FileUploaderCommon.FileDrop = FileDrop;
	    FileUploaderCommon.FileOver = FileOver;
	}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (fileUploaderOptions, $rootScope, $http, $window, FileLikeObject, FileItem) {
	    ...
	    var FileUploaderCommon = (function () {
	        /**********************
	         * PUBLIC
	         **********************/
	        /**
	         * Creates an instance of FileUploaderCommon
	         * @param {Object} [options]
	         * @constructor
	         */
	
	        function FileUploaderCommon(options) {
	            _classCallCheck(this, FileUploaderCommon);
	        ...
	        _createClass(FileUploaderCommon, {
	            addToQueue: {
	                /**
	            ...
	            destroy: {
	                /**
	                 * Destroys instance of FileUploaderCommon
	                 */
	     ...
	     * @readonly
	     */
	    FileUploaderCommon.prototype.isHTML5 = !!(File && FormData);
	    /**********************
	     * STATIC
	     **********************/
	    /**
	     * @borrows FileUploaderCommon.prototype.isHTML5
	     */
	    FileUploaderCommon.isHTML5 = FileUploaderCommon.prototype.isHTML5;
	
	    return FileUploaderCommon;
	};
	
	module.exports.$inject = ["fileUploaderOptionsCommon", "$rootScope", "$http", "$window", "FileLikeObjectCommon", "FileItemCommon"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function ($compile, FileLikeObject) {
	    var FileItem = (function () {
	         ...
	         * @param {FileUploaderCommon} uploader
	...
	module.exports.$inject = ["$compile", "FileLikeObjectCommon"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.$inject = ["FileDirectiveCommon"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function ($parse, FileUploaderCommon, FileSelect) {
	
	    return {
	        link: function (scope, element, attributes) {
	            var uploader = scope.$eval(attributes.uploader);
	
	            if (!(uploader instanceof FileUploaderCommon)) {
	                throw new TypeError("\"Uploader\" must be an instance of FileUploaderCommon");
	            }
	...
	module.exports.$inject = ["$parse", "FileUploaderCommon", "FileSelectCommon"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function ($parse, FileUploaderCommon, FileDrop) {
	...
	module.exports.$inject = ["$parse", "FileUploaderCommon", "FileDrop"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (FileUploaderCommon, FileOver) {
	...
	module.exports.$inject = ["FileUploaderCommon", "FileOverCommon"];
