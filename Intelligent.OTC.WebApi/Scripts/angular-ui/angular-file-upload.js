    ...
    */
    ...
    .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile',
        function (fileUploaderOptions, $rootScope, $http, $window, $compile) {
            ...
            FileUploader.prototype.addToQueue = function (files, options, filters) {
                ...
                angular.forEach(list, function (some /*{File|HTMLInputElement|Object}*/) {
                    ...
                    if (this._isValidFile(temp, arrayOfFilters, options)) {
                        ...
                        //��������
                        if (filters == "updAccountFile") {
                            this.queue[0] = fileItem;
                        } else if (filters == "updInvoiceFile") {
                            this.queue[1] = fileItem;
                        } else if (filters == "updInvoiceDetailFile") {
                            this.queue[2] = fileItem;
                        } else if (filters == 'updCustFile') {
                            this.queue[4] = fileItem;
                        } else if (filters == 'updVarFile') {
                            this.queue[5] = fileItem;
                        } else if (filters == 'updSAPInvoiceFile') {
                            this.queue[6] = fileItem;
                        } else if (filters == 'updCreditHoldFile') {
                            this.queue[7] = fileItem;
                        } else if (filters == 'updCurrencyAmountFile') {
                            this.queue[8] = fileItem;
                        } else if (filters == 'updBSFile') {
                            this.queue[9] = fileItem;
                        } else if (filters == 'updRemittanceFile') {
                            this.queue[10] = fileItem;
                        } else if (filters == 'updTWCurrencyAmountFile') {
                            this.queue[11] = fileItem;
                        } else if (filters == 'updATMCurrencyAmountFile') {
                            this.queue[12] = fileItem;
                        } else if (filters == 'updpmtFile') {
                            this.queue[13] = fileItem;
                        } else if (filters == 'updConsignmentNumberFile') {
                            this.queue[14] = fileItem;
                        } else {
                            this.queue[3] = fileItem;
                        }
            ...
            * Event handler
            */
            FileSelect.prototype.onChange = function (id) {
                var files = this.uploader.isHTML5 ? this.element[0].files : this.element[0];
                var options = this.getOptions();
                var filters = id.target.id;
