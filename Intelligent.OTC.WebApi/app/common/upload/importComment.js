angular.module('app.common.importComment', [])

    .controller('importCommentCtrl', ['$scope', 'importType','title', 'FileUploader','APPSETTING','$uibModalInstance',

        function ($scope, importType, title, FileUploader,APPSETTING,$uibModalInstance) {
            var uploader = $scope.uploader = new FileUploader({
                url: APPSETTING['serverUrl'] + '/api/Customer'
            });

            $scope.title = title ? title :'Import Comments File';
            ...
            $scope.importExcel = function () {
                ...
                console.log('++++++++++++++' + title);
                var type = importType ? importType :'importcomment';
